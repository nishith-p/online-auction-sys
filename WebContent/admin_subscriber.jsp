...
<%@page import="com.onlineauction.service.SubscriberService"%>
...
<%@page import="com.onlineauction.model.Subscriber"%>
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="admin_subscriber.jsp" class="sidebar-text-active ml-4">
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header mx-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">Subscribers</h5>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="profile-wrapper border mb-4 mt-4">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <% subList = subService.getAllSubscribers();
                                  
                                  	 for (Subscriber sub: subList) { 
                                  	 
                                  %>
                                    <tr>
                                      <th scope="row"><%=sub.getSub_id() %></th>
                                      <td><%=sub.getEmail()%></td>
                                      <td>
                                        
                                        <form method="get" action="SubscriberServlet">
                                          
                                            <button type="submit" class="btn btn-danger" name="btn-value" value=<%=sub.getSub_id() %>>Delete</button>  

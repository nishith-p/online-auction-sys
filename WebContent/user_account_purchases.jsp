...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
 ...
 <body>
 	...
 	<% CustomerService cus = new CustomerService(); 
	   ...
	   List<Bid> bids = bidService.getBid(cusId);
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0 d-none d-lg-block" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="user_account_purchases.jsp" class="sidebar-text-active ml-4">
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header ml-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">My Purchases</h5>
		    						 ...
		    						 if (status) { %>
		    							 <td>
		    							 	...
		    							 	<form method="get" action="OrderServlet">
		    							 		...
		    							 		<button type="submit" class="btn btn-primary" name="btn-value" value=<%=auction.getAuctionId() + "-" + cusId + "-" + element.getBidId() + "-" + auction.getCurrentPrice()%>>Pay Now!</button>

...
<%@page import="com.onlineauction.service.FavouriteService"%>
<%@page import="com.onlineauction.model.Customer"%>
<%@page import="com.onlineauction.model.Auction"%>
<%@page import="com.onlineauction.model.Favourite"%>
    ...
    <div class="wrapper">
        ...
        <div class="container-fluid" style="background: #F5F5F5;">
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0" style="background: #202729;">
                    ...
                    <div class="side-menu-title">
                        ...
                        <p class="py-2 ml-3">Admin Panel</p>
                    
                    </div>
                  
                    <div class="sidebar-tabs mt-n3 py-3">
                    
                        <a href="admin_customer.jsp" class="sidebar-text ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-cogs"></i></span>
                            <h6 class="d-inline">Manage Customers</h6>
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="admin_auction.jsp" class="sidebar-text-active ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-cogs"></i></span>
                            <h6 class="d-inline">Manage Auctions</h6>
                    ...
                    <div class="sidebar-tabs py-3">
                        ...
                        <a href="admin_bid.jsp" class="sidebar-text ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-heart"></i></span>
                            <h6 class="d-inline">Bids</h6>
                    ...
                    <div class="sidebar-tabs py-3">
                        ...
                        <a href="admin_payment.jsp" class="sidebar-text ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-arrow-circle-up"></i></span>
                            <h6 class="d-inline">Payments</h6>
                    ...
                    <div class="sidebar-tabs py-3">
                        ...
                        <a href="admin_message.jsp" class="sidebar-text ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-tasks"></i></span>
                            <h6 class="d-inline">Messages</h6>
                    ...
                    <div class="sidebar-tabs py-3">
                        ...
                        <a href="admin_subscriber.jsp" class="sidebar-text ml-4">
                            
                            <span class="d-inline mr-2"><i class="fas fa-tasks"></i></span>
                            <h6 class="d-inline">Subscribers</h6>
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header mx-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">Manage Customers</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="profile-wrapper border mb-4 mt-4">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <% auctions = auc.getAllAuctions();
                                  
                                  	 for (Auction auct: auctions) { 
                                  	 	customer = cus.getCustomerById(auct.getCus_id());
                                  %>
                                    <tr>
                                      <th scope="row"><%=auct.getAuctionId() %></th>
                                      <td><%=auct.getItemName() %></td>
                                      <td><%=customer.getFirstName() %> <%=customer.getLastName() %></td>
                                      <td><%=auct.getCurrentPrice() %></td>
                                      <td><%=auct.getEndDate() %></td>
                                      <td>
                                        
                                        <form class="d-inline-block mr-2" method="get" action="AuctionServlet">
                                          
                                            <button type="submit" class="btn btn-success" name="btn-value" value=<%="view." + auct.getAuctionId() %>>View</button>  
                                          
                                        </form> 
                                        
                                        <form class="d-inline-block" method="get" action="AuctionServlet">
                                          
                                            <button type="submit" class="btn btn-danger" name="btn-value" value=<%="delete." + auct.getAuctionId() %>>Delete</button>  

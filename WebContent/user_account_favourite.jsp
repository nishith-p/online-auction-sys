...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
 ...
 <body>
 	...
 	<% CustomerService cus = new CustomerService(); 
 	   ...
 	   FavouriteService fav = new FavouriteService();
 	   Auction auct;
	
	   int cusId = (int) session.getAttribute("cus_id");
	   Customer customer = cus.getCustomerById(cusId);
	   List<Favourite> favourite = fav.getFavourites(cusId);
	   List<Auction> auction = new ArrayList<>();
	   
	   for (Favourite obj: favourite) {
		  auct = auc.getAuctionById(obj.getAuctionId());
		  auction.add(auct);
	   }
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0 d-none d-lg-block" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="user_account_favourite.jsp" class="sidebar-text-active ml-4">
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header ml-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">My Favourites</h5>
                    ...
                    <% for (Auction element: auction) { 
                    	Customer customer1 = cus.getCustomerById(element.getCus_id());
                    %>
                    
                        <div class="col-lg-3">
                        
                            <div class="profile-wrapper border my-3 my-lg-4" style="background: none;">
                                ...
                                <div id="test-card" class="card">
                                    ...
                                    <div class="card-overlay">
                                        <div class="text">
                                        	...
                                        	<form method="get" action="AuctionServlet" class="my-2">
                                            ...
                                            <form method="get" action="FavouriteServlet">
                                                ...
                                                <button type="submit" class="btn btn-outline-info" name="btn-value" value=<%="delete." + element.getAuctionId() + "." + cusId%>><i class="fas fa-trash" style="margin-right: 5px;"></i>Delete...</button> 
                                    ...
                                    <div class="card-body">
                                      ...
                                      <img src="uploads/<%=customer1.getImage() %>" alt="..." class="rounded-circle">
                                      ...
                                      <h6 style="font-weight: 600; padding-top: 10px;" class="card-text"><%=customer1.getFirstName() %> <%=customer1.getLastName() %></h6>

...
<%@page import="com.onlineauction.service.MessageService"%>
...
<%@page import="com.onlineauction.model.Message"%>
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs py-3">
                        ...
                        <a href="admin_auction.jsp" class="sidebar-text ml-4">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="admin_message.jsp" class="sidebar-text-active ml-4">
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header mx-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">Messages</h5>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="profile-wrapper border mb-4 mt-4">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <% msj = message.getAllMessages();
                                  
                                  	 for (Message msjt: msj) { 
                                  	 
                                  %>
                                    <tr>
                                      <th scope="row"><%=msjt.getMsjId() %></th>
                                      <td><%=msjt.getName() %></td>
                                      <td><%=msjt.getEmail() %></td>
                                      <td><%=msjt.getMessage() %></td>
                                      <td>
                                        
                                        <form method="get" action="MessageServlet">
                                          
                                            <button type="submit" class="btn btn-danger" name="btn-value" value=<%=msjt.getMsjId() %>>Delete</button>  

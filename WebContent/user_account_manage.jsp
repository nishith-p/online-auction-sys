...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
 ...
 <body>
 	...
 	<% CustomerService cus = new CustomerService(); 
	   ...
	   List<Auction> auction = auc.getAuctionByAnyType(String.valueOf(cusId), "cus_id");
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0 d-none d-lg-block" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="user_account_manage.jsp" class="sidebar-text-active ml-4">
                ...
                <div class="col-lg-10" style="background: ;">
                    ...
                    <div class="row">
                        ...
                        <div class="side-menu-header ml-lg-5 mx-3 mt-4 border-top border-right border-bottom">
                            ...
                            <h5 class="py-3 ml-3">Manage Items</h5>
                                    ...
                                    <div class="card-overlay">
                                        <div class="text">
                                            ...
                                            <form method="get" action="AuctionServlet">
                                                ...
                                                <button type="submit" class="btn btn-outline-info" name="btn-value" value=<%=element.getAuctionId() %>><i class="fas fa-trash" style="margin-right: 5px;"></i>Delete...</button> 

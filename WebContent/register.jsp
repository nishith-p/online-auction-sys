                ...
                <!--<div class="col-md-4 justify-content-md-center">-->
                    ...
                    <div class="register-form">
                        ...
                        <div class="register-form-top">
                            ...
                            <h3 class="pt-4 ml-3">Register Account</h3>
                            <p class="pb-3 ml-3">Register now and start making money from home!</p>
                        
                        </div>
                        
                        <form class="register-form-bottom" method="post" action="Register">
                        
                            <div class="form-group mx-3">
                                        
                                <label for="email">Email Address <span style="color: #00d7b3;">*</span></label>
                            ...
                            <div class="form-group mx-3">
                                ...
                                <label for="uName">User Name <span style="color: #00d7b3;">*</span></label>
                            ...
                            <div class="form-group mx-3">
                                ...
                                <label for="password">Password <span style="color: #00d7b3;">*</span></label>
                            ...
                            <div class="form-group mx-3">
                                ...
                                <label for="rPassword">Repeat Password <span style="color: #00d7b3;">*</span></label>
                                <input type="password" class="form-control" id="rPassword" placeholder="Repeat Password" required>

                            </div>
                            
                            <div class="text-center mb-3 register-btn">
                                    
                                <button style="width: 90%;" type="submit" class="btn btn-dark" name="btn-value" value="register">Register <span style="color: #00d7b3;">Now!</span></button>

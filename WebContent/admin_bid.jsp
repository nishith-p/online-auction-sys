...
<%@page import="com.onlineauction.service.BidService"%>
<%@page import="com.onlineauction.model.Customer"%>
<%@page import="com.onlineauction.model.Auction"%>
<%@page import="com.onlineauction.model.Bid"%>
            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active py-3">
                        ...
                        <a href="admin_bid.jsp" class="sidebar-text-active ml-4">
                            ...
                            <div class="profile-wrapper border mb-4 mt-4">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <% bids = bid.getAllBids();
                                  	 ...
                                  	 for (Bid element: bids) { 
                                  	 	Auction auction = auc.getAuctionById(element.getAuctionId());
                                  	 	Customer cust = cus.getCustomerById(element.getCusId());
                                  	 	
                                  %>
                                    <tr>
                                      <th scope="row"><%=element.getBidId() %></th>
                                      ...
                                      <% LocalDate ldate = java.time.LocalDate.now();
 		    						 	 String date2 = String.valueOf(ldate);
 		    						 	 String date1 = auction.getEndDate();
 		    						 	 
 		    						 	 if (date2.compareTo(date1) > 0 ) {
		    							 	if (element.getPrice() == auction.getCurrentPrice()) { %>
		    							 		<td>Won</td>
		    						   <%   } else { %>
		    						 		    <td>Lost</td>
		                                 <% }

            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="login-form">
                    ...
                    <div class="login-form-top">
                        ...
                        <h3 class="pt-4 ml-3">Login to your Account</h3>
                        <p class="pb-3 ml-3">Enter now to your account and start buying and selling!</p>

                    </div>

                    <form class="login-form-bottom" method="post" action="Login">

                        <div class="form-group mx-3">

                            <label for="uName">User Name</label>
                            <input type="text" class="form-control" name="uName" placeholder="User Name or Email" required>
                        ...
                        <div class="text-center mb-3 login-btn">

                            <button style="width: 90%;" type="submit" class="btn btn-dark">Login <span style="color: #00d7b3;">Now!</span></button>

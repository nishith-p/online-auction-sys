...
<body>
    ...
    <div class="container">
    	...
    	<div class="row-chk">
  <div class="col-75-chk" style="padding: 40px 0 40px 0;">
    <div class="container-chk">
      <form method="post" action="OrderServlet">

        <div class="row-chk" style="padding-top:10px">
          <div class="col-50-chk">
            ...
            <input type="text" id="adr" name="address" placeholder="55, Ward Place">
        ...
        <button type="submit" class="btn-chk" name="btn-value" value=<%=auctionId + "-" + cusId + "-" + bidId + "-" + price%>>Proceed to Checkout</button>
      </form>
    </div>
  </div>
</div>

            ...
            <div class="row">
                ...
                <div id="sidebar" class="col-lg-2 px-0" style="background: #202729;">
                    ...
                    <div class="sidebar-tabs-active mt-n3 py-3">
                        ...
                        <a href="admin_customer.jsp" class="sidebar-text-active ml-4">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="profile-wrapper border mb-4 mt-4">
                                ...
                                <table class="table table-hover">
                                  ...
                                  <% customers = cus.getAllCustomers();
                                  
                                  	 for (Customer cust: customers) { 
                                  	 
                                  %>
                                    <tr>
                                      <th scope="row"><%=cust.getCus_id() %></th>
                                      ...
                                      <td>
                                        ...
                                        <form method="get" action="CustomerServlet">
                                            ...
                                            <button type="submit" class="btn btn-danger" name="btn-value" value=<%=cust.getCus_id() %>>Delete</button>  

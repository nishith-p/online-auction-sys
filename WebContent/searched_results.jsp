...
<body>
	...
	<% String category = (String) request.getAttribute("category");
	   ...
	   List<Auction> auctions = auc.getAuctionByAnyType(category, "other");
	   
	   if (category == null) {
		   if (request.getAttribute("sPrice") == null & request.getAttribute("itemName") == null) {
			   String itemName = (String) request.getAttribute("product");

			   auctions = auc.getAuctionByAnyType(itemName, "item");
		   } else if (request.getAttribute("sPrice") != null & request.getAttribute("itemName") == null) {
			   String sPrice = (String) request.getAttribute("sPrice");
			   String ePrice = (String) request.getAttribute("ePrice");
			   
			   auctions = auc.getAuctionByPrice(Double.parseDouble(sPrice), Double.parseDouble(ePrice));
		   } else  {
			   String itemName = (String) request.getAttribute("itemName");
			   String homeCategory = (String) request.getAttribute("home-category");
			   
			   if (homeCategory.equalsIgnoreCase("0")) {
				   auctions = auc.getAuctionByAnyType(itemName, "item");
			   } else {
				   auctions = auc.getAuctionByNameAndCategory(itemName, homeCategory);
			   }
		   }
	   }
		   %>
